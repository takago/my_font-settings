...
sudo wget https://raw.githubusercontent.com/takago/my_font-settings/main/78-Reject.conf -P /etc/fonts/conf.d/ -Nq

# Ryumin, GothicBBB, sans-serif, serif, monospace の設定（鷹合の好みに）
sudo wget https://raw.githubusercontent.com/takago/my_font-settings/main/local.conf -P /etc/fonts/ -Nq
